...
/**
 * <h2>Persistent value</h2> A utility class for managing variables and
 * persisting them to JSON files. This class allows storing variables of any
 * type and saving them to JSON files for later retrieval.
 * <hr>
...
public class PersistentValue<T> {
	...
	/**
	 * Constructor with a file reference, that will load the variable from the file
	 * if it
	 *
