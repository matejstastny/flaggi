// ------------------------------------------------------------------------------
// PlayerGameObject.java - Player-specific game object with stats and state
// ------------------------------------------------------------------------------
...
public class PlayerGameObject extends GameObject {
	...
	public ServerGameObject toProto() {
		return ServerGameObject.newBuilder().setType(GameObjectType.PLAYER).setX(x()).setY(y()).setCollX(collision().getX()).setCollY(collision().getY()).setCollWidth(collision().getWidth()).setCollHeight(collision().getHeight()).setSkin(skin).setAnimation(animation).setFacingLeft(facingLeft).setHp(hp()).setFlagCount(flagCount).setUsername(username).build();
	}
