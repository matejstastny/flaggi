...
/**
 * Utility class for getting screen-related information such as dimensions. Supports single and
...
public class ScreenUtil {
    ...
    /**
     * Gets the screen dimensions of the user's primary screen using {@code Toolkit}.
     *
    ...
    /**
     * Returns a list of dimensions for all connected screens. Supports multi-monitor setups.
     *
    ...
    public static int[][] getAllScreensDimensions() {
        ...
        for (int i = 0; i < screenDevices.length; i++) {
            Dimension screenSize =
                    screenDevices[i].getDefaultConfiguration().getBounds().getSize();
