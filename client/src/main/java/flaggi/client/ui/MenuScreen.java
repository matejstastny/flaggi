...
public class MenuScreen extends Renderable implements Interactable, Typable {
    ...
    private void renderStartButton(Graphics2D g, Container fcra) {
        ...
        int[] startButtonTextPos =
                FontUtil.getCenteredPosition(startButton.width, startButton.height, g.getFontMetrics(), "START");
        if (!buttonActive) {
    ...
    private void loadFont() {
        try {
            this.font = FontUtil.createFontFromResource("fonts/PixelifySans-VariableFont_wght.ttf")
