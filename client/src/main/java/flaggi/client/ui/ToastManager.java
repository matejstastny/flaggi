...
/**
 * A manager class for displaying toast messages on the screen. Toasts are small pop-up messages
 * that appear on the screen for a short period of time. The ToastManager class is responsible for
 * rendering the toasts and managing their display duration.
 */
